...
public class Base64 {
	...
	/**
	 * Encodes a string in Base64 notation with line breaks after every 75 Base64
	 * characters.
	 * 
	 * @param s
	...
	/**
	 * Decodes data from Base64 notation and returns it as a string. Equivlaent to
	 * calling <code>new String( decode( s ) )</code>
	 * 
	 * @param s
	...
	public static class InputStream extends java.io.FilterInputStream {
		 ...
		 * @since 1.3
		 */
		public InputStream(java.io.InputStream in,boolean enc) {
			this(in,enc,true);
		} // end constructor
		 ...
		 * @since 1.3
		 */
		public InputStream(java.io.InputStream in,boolean enc,boolean brkLines) {
			super(in);
			this.breakLines = brkLines;
			this.encode = enc;
			if (enc){
			this.bufferLength = 4; 
			}else{
	...
	public static class OutputStream extends java.io.FilterOutputStream {
		 ...
		 * @since 1.3
		 */
		public OutputStream(java.io.OutputStream out,boolean enc) {
			this(out,enc,true);
		} // end constructor
		 ...
		 * @since 1.3
		 */
		public OutputStream(java.io.OutputStream out,boolean enc,boolean brkLines) {
			super(out);
			this.breakLines = brkLines;
			this.encode = enc;
			if (enc){
		 ...
		 * @param theByte
		 *          the byte to write
		 * @throws java.io.IOException when IO errors occurs
		 * @since 1.3
		 */
		...
		/**
		 * Appropriately pads Base64 notation when encoding or throws an exception
		 * if Base64 input is not properly padded when decoding.
		 * 
		 * @since 1.3
		 * @throws java.io.IOException when IO errors occurs
		 */
